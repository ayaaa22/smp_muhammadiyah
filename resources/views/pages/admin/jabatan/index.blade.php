                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped align-middle">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#modalEditJabatan{{ $jabatan->id }}">Edit</a>
                                <!-- Modal Edit Jabatan -->
                                <div class="modal fade" id="modalEditJabatan{{ $jabatan->id }}" tabindex="-1" aria-labelledby="modalEditJabatanLabel{{ $jabatan->id }}" aria-hidden="true">
                                        ...
                                        <form action="{{ route('jabatan.update', $jabatan->id) }}" method="POST">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="modalEditJabatanLabel{{ $jabatan->id }}">Edit Jabatan</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="is_active" class="form-label">Status Jabatan</label>
                                                        <select name="is_active" class="form-control">
                                                            <option value="aktif" {{ $jabatan->is_active === 'aktif' ? 'selected' : '' }}>Aktif</option>
                                                            <option value="nonaktif" {{ $jabatan->is_active === 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                                                        </select>
                                                    </div>
                                                </div>
                                ...
                                <form action="{{ route('jabatan.delete', $jabatan->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Apakah Anda yakin ingin menghapus jabatan ini?');">
                                    @csrf
                                    @method('DELETE')
