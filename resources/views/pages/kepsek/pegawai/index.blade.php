        ...
        <div class="card shadow rounded">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('kepsek-pegawai.add') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('kepsek-pegawai.edit', $item->id) }}" class="btn btn-sm btn-outline-primary me-1">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>
                                    <form action="{{ route('kepsek-pegawai.delete', $item->id) }}" method="POST" style="display:inline-block" onsubmit="return confirm('Yakin hapus?')">
                                        @csrf
                                        @method('DELETE')
